...
export const convertCalendars = (type, year, month, day, op={}) => {
  if (type === "hijri") {
    ...
    const hijriMoment = moment(`${year}/${month}/${day}`, 'YYYY/M/D')
    const hijriDate = new HijriDate(hijriMoment.iYear(), hijriMoment.iMonth(), hijriMoment.iDate());
    return hijriDate
  }
}