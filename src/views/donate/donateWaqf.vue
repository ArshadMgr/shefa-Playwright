<template>
  <div v-if="waqfDetails && !closedWaqfCondition" class="donate px-3 px-md-5 mb-5">
    <div class="donate__container">
      ...
      <div class="donate__card donate__form col-md-6 section">
        ...
        <div class="tags d-flex justify-content-evenly mb-5">
          ...
          <div class="tag fw-semibold" @click="donationModel.donation_amount = waqfDetails.target - waqfDetails.balance">التبرع بالمبلغ
            المتبقي
          </div>
        </div>
        ...
        <div class="row my-5">
          ...
          <Button class="donate__button p-button-rounded p-button p-button-primary mt-2 mx-auto"
                  @click.stop="donate"
...
export default {
  ...
  components: {DonateCardDetails, DonationFailureDialog, DonationSuccessDialog, BaseSpinner, CompletedDonation, ProgressBar, Dialog },
  data() {
    return {
  ...
  methods: {
    ...
    onShareClicked(platform) {
      ...
      let facebookShareURL = "https://www.facebook.com/sharer.php?u=" + FEURL + "/donate-waqf/" + this.waqfDetails?.id;
      let whatsappShareURL = "https://wa.me/?text=" + FEURL + "/donate-waqf/" + this.waqfDetails?.id;
      let twitterShareURL = "https://twitter.com/share?url=" + FEURL + "/donate-waqf/" + this.waqfDetails?.id;
